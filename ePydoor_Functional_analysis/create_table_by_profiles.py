...
fi = open("Exonizations_Functional_Analysis_VYAS.txt", "r")
...
fi = open("Neoskipping_Functional_Analysis_VYAS.txt", "r")
...
fo = open("grouped_barplot_table_profiles_VYAS.txt", "w")

fo.write("Splicing_event\tCondition\tProfiles\n")
